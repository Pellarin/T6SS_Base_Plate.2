...
pdbfile="../../modeller/VgrG/VGRG.B99990005.pdb"
fasta_file="VgrG.crosslink.fasta"


conversion_chainid_name = {"A":"VgrG.1",
                           "B":"VgrG.2",
                           "C":"VgrG.3"}

conversion_fastanames_name = {"VgrGHA.1":"VgrG.1",
                              "VgrGHA.2":"VgrG.2",
                              "VgrGHA.3":"VgrG.3"}
...
offsets={"VgrG.1":{(1, 841):0},"VgrG.2":{(842, 1682):-841},"VgrG.3":{(1683, 2523):-1682}}
...
dof.create_rigid_body(mols.values(),
                      nonrigid_parts=[mols[mol].get_non_atomic_residues() for mol in mols],
                      max_trans=0.0,
                      max_rot=0.0,
...
rex=IMP.pmi.macros.ReplicaExchange0(m,
                                    ...
                                    global_output_directory='output_VgrG/',
