...
for csv in ["../../crosslinks/Exp1-BP-CXMS-12aout16-KFG.csv","../../crosslinks/Exp2-KFG-081016-2.csv",
    ...
    if csv in ["../../crosslinks/Vgrg-Tle1.csv","../../crosslinks/Vgrg-Tle1-2-1008.csv"]:
...
fo=FO("Decision",operator.eq,"Accepted")&FO(cldb.redundancy_key,operator.gt,2)
...
sequences={}
for i  in prots:
    sequences[i]=("VgrG.crosslink.fasta",  inv_conversion_fastanames_name[i], i)
